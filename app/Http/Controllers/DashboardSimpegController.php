...
class DashboardSimpegController extends Controller
{
    public function dashboard()
    {
        ...
        $CountCPNSTenagaTeknis = DB::select('SELECT count(*) as CountPNSTenagaTeknis FROM (pegawai p INNER JOIN master_jab j ON p.nip = j.nip_defenitif) WHERE p.kode_kedudukan_pegawai = 1 AND p.is_deleted = 0 AND j.is_delete = 0 AND p.kode_status_pegawai = 1 AND j.kode_kategori_jab = 1');
        $CountCPNSTenagaKesehatan = DB::select('SELECT count(*) as CountPNSTenagaTeknis FROM (pegawai p INNER JOIN master_jab j ON p.nip = j.nip_defenitif) WHERE p.kode_kedudukan_pegawai = 1 AND p.is_deleted = 0 AND j.is_delete = 0 AND p.kode_status_pegawai = 1 AND j.kode_kategori_jab = 2');
        $CountCPNSTenagaGuru = DB::select('SELECT count(*) as CountPNSTenagaTeknis FROM (pegawai p INNER JOIN master_jab j ON p.nip = j.nip_defenitif) WHERE p.kode_kedudukan_pegawai = 1 AND p.is_deleted = 0 AND j.is_delete = 0 AND p.kode_status_pegawai = 1 AND j.kode_kategori_jab = 3');
        ...
        $CountPNSTenagaKesehatan = DB::select('SELECT count(*) as CountPNSTenagaTeknis FROM (pegawai p INNER JOIN master_jab j ON p.nip = j.nip_defenitif) WHERE p.kode_kedudukan_pegawai = 1 AND p.is_deleted = 0 AND j.is_delete = 0 AND p.kode_status_pegawai = 2 AND j.kode_kategori_jab = 2');
        $CountPNSTenagaGuru = DB::select('SELECT count(*) as CountPNSTenagaTeknis FROM (pegawai p INNER JOIN master_jab j ON p.nip = j.nip_defenitif) WHERE p.kode_kedudukan_pegawai = 1 AND p.is_deleted = 0 AND j.is_delete = 0 AND p.kode_status_pegawai = 2 AND j.kode_kategori_jab = 3');
        $CountPPPKTenagaTeknis = DB::select('SELECT count(*) as CountPNSTenagaTeknis FROM (pegawai p INNER JOIN master_jab j ON p.nip = j.nip_defenitif) WHERE p.kode_kedudukan_pegawai = 1 AND p.is_deleted = 0 AND j.is_delete = 0 AND p.kode_status_pegawai = 7 AND j.kode_kategori_jab = 1');
        $CountPPPKTenagaKesehatan = DB::select('SELECT count(*) as CountPNSTenagaTeknis FROM (pegawai p INNER JOIN master_jab j ON p.nip = j.nip_defenitif) WHERE p.kode_kedudukan_pegawai = 1 AND p.is_deleted = 0 AND j.is_delete = 0 AND p.kode_status_pegawai = 7 AND j.kode_kategori_jab = 2');
        $CountPPPKTenagaGuru = DB::select('SELECT count(*) as CountPNSTenagaTeknis FROM (pegawai p INNER JOIN master_jab j ON p.nip = j.nip_defenitif) WHERE p.kode_kedudukan_pegawai = 1 AND p.is_deleted = 0 AND j.is_delete = 0 AND p.kode_status_pegawai = 7 AND j.kode_kategori_jab = 3');
